            ...
            <div class="row">
                ...
                <div id="formuRegistro" class="col-md-6">
                    ...
                    <form role="form" method="Post" action="Controlador1" id="FormularioUser" name="FormularioUser">
                        <input class="form-control" type="hidden" name="accion" value="RegistroUser" />
                        <label>Correo Electronico</label>
                        <input class="form-control"type="text" id="Correo"name="Correo" placeholder="example@example.com"/><br>
                        <label>Nombre y Apellido</label>
                        <input class="form-control"type="text" id="Nombre"name="Nombre" placeholder="Jose Perez"/><br>
                        <label>Usuario</label>
